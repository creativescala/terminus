...
/** Combined capability context for interactive component bodies.
  *
  * Bundles [[ComponentContext]], [[EventContext]], and [[RenderContext]] into a
...
object AppContext:
  ...
  /** Creates a child AppContext that delegates [[ComponentContext]] and
    * [[EventContext]] to the parent, but uses rc as the [[RenderContext]].
    *
    ...
    */
  def child(parent: AppContext, rc: RenderContext): AppContext =
    new AppContext:
